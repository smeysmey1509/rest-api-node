...
const sidebar_item_model_1 = __importDefault(require("../sidebar-item.model"));
let mongo;
...
(0, vitest_1.afterEach)(() => __awaiter(void 0, void 0, void 0, function* () {
    yield sidebar_item_model_1.default.deleteMany({});
}));
...
(0, vitest_1.describe)("Sidebar Items API", () => {
    ...
    (0, vitest_1.it)("sidebar tree sorts by order", () => __awaiter(void 0, void 0, void 0, function* () {
        yield sidebar_item_model_1.default.create({
            name: "Second",
            path: "/second",
            icon: "second",
            order: 2,
    ...
    (0, vitest_1.it)("sidebar tree builds parent-child structure", () => __awaiter(void 0, void 0, void 0, function* () {
        const parent = yield sidebar_item_model_1.default.create({
        ...
        const child = yield sidebar_item_model_1.default.create({
