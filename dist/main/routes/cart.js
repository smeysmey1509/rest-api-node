...
const cartSanitizer_1 = require("../utils/cartSanitizer");
...
router.get("/cart", auth_1.authenticateToken, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const response = {
            _id: cart._id,
            user: cart.user,
            items: (0, cartSanitizer_1.sanitizeCartItems)(cart.items),
...
router.put("/cart/update/:productId", auth_1.authenticateToken, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        yield cart.save();
        yield (0, cache_1.invalidateCart)(req.user.id);
        const cartPayload = typeof cart.toObject === "function" ? cart.toObject() : cart;
        res.status(200).json(Object.assign(Object.assign({}, cartPayload), { items: (0, cartSanitizer_1.sanitizeCartItems)(cartPayload.items) }));
        return;
    }
    catch (err) {
        console.error(err);
