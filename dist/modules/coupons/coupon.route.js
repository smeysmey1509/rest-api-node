...
router.get("/promocode", auth_middleware_1.authenticateToken, checkAdmin, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const promos = yield coupon_model_1.default.find().sort({ expiresAt: 1 }); // sort by expiration date ascending
...
router.post("/promocode/create", auth_middleware_1.authenticateToken, checkAdmin, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const existing = yield coupon_model_1.default.findOne({ code: code.toUpperCase() });
        if (existing) {
            res.status(409).json({ error: "Promo code already exists." });
            return;
        }
        const promo = new coupon_model_1.default({
