...
function ensureCategory(categoryId, categoryName) {
    return __awaiter(this, void 0, void 0, function* () {
        const existing = yield category_model_1.default.findOne({ categoryId }).select("_id");
        if (existing)
            return existing;
...
function ensureBrand(brandName, slug) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const existingByName = yield brand_model_1.default.findOne({
            name: { $regex: new RegExp(`^${escapedName}$`, "i") },
        }).select("_id");
        if (existingByName)
            return existingByName;
        const escapedSlug = escapeRegExp(slug);
        const existingBySlug = yield brand_model_1.default.findOne({
            slug: { $regex: new RegExp(`^${escapedSlug}$`, "i") },
        }).select("_id");
        if (existingBySlug)
            return existingBySlug;
        console.log(`Creating brand ${brandName} (${slug})`);
        return brand_model_1.default.create({ name: brandName, slug, isActive: true });
    });
}
...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const seller = yield user_model_1.default.findById(options.sellerId).select("_id");
        if (!seller) {
        ...
        const inserted = yield product_model_1.default.insertMany(products, { ordered: false });
