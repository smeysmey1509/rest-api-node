...
const createProduct = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const basePrice = Array.isArray(normVariants) && normVariants.length
            ? Math.min(...normVariants.map(v => v.price))
            : (topLevelPrice !== null && topLevelPrice !== void 0 ? topLevelPrice : 0);
        const cmp = toNumber(compareAtPrice, NaN);
        const safeCompareAt = Number.isFinite(cmp) && cmp <= basePrice ? cmp : undefined;
        // ---------- STRICT DUP CHECKS ----------
