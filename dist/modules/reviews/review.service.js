    ...
    create(userId, payload) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!productId || !mongoose_1.default.isValidObjectId(productId)) {
                throw new app_error_1.AppError("Valid productId is required", 400);
            }
            ...
            if (!purchased) {
                throw new app_error_1.AppError("Only purchased products can be reviewed.", 403);
            }
            try {
                ...
                if ((err === null || err === void 0 ? void 0 : err.code) === 11000)
                    throw new app_error_1.AppError("You already reviewed this product", 409);
                throw err;
            }
        });
    },
